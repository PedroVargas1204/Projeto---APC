...
So lida com tela e entrada — nao contem regra de negocio.
...
def linha(texto=""):
    """Imprime uma linha dentro da 'moldura' (largura vinda do config)."""
    print(f"| {texto:<{config.LARGURA_TELA}} |")


def borda():
    """Imprime a borda horizontal das telas."""
    print("+" + "-" * (config.LARGURA_TELA + 2) + "+")
