...
Separacao: calcular_impacto / resumo_impacto / agregar_por_categoria sao
logica pura (sem tela); exibir_impacto e a tela.
...
def converter_para_kg(quantidade, unidade):
    ...
    'unid' usa o peso medio definido no config.
    """
...
def calcular_impacto(historico, base, periodo_dias=config.PERIODO_IMPACTO_DIAS):
    """
...
def resumo_impacto(historico, base, periodo_dias=config.PERIODO_IMPACTO_DIAS):
